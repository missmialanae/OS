...
#include "frontends/qmps/address_line_edit.h"
...
QT_INIT_METAOBJECT const QMetaObject AsidLineEdit::staticMetaObject = { {
    &QLineEdit::staticMetaObject,
    qt_meta_stringdata_AsidLineEdit.data,
    qt_meta_data_AsidLineEdit,
    qt_static_metacall,
    nullptr,
    nullptr
} };
