...
#include "frontends/qmps/tlb_model.h"
...
void TLBModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<TLBModel *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject TLBModel::staticMetaObject = { {
    &QAbstractTableModel::staticMetaObject,
    qt_meta_stringdata_TLBModel.data,
    qt_meta_data_TLBModel,
    qt_static_metacall,
    nullptr,
    nullptr
} };
