...
#include "frontends/qmps/machine_config_dialog.h"
...
void MachineConfigDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<MachineConfigDialog *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject MachineConfigDialog::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_MachineConfigDialog.data,
    qt_meta_data_MachineConfigDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
