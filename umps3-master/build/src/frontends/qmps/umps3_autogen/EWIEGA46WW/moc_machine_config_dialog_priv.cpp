...
#include "frontends/qmps/machine_config_dialog_priv.h"
...
void DeviceFileChooser::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<DeviceFileChooser *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject DeviceFileChooser::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_DeviceFileChooser.data,
    qt_meta_data_DeviceFileChooser,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
QT_INIT_METAOBJECT const QMetaObject NetworkConfigWidget::staticMetaObject = { {
    &QWidget::staticMetaObject,
    qt_meta_stringdata_NetworkConfigWidget.data,
    qt_meta_data_NetworkConfigWidget,
    qt_static_metacall,
    nullptr,
    nullptr
} };
