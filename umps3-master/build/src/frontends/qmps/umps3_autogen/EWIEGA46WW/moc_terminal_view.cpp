...
#include "frontends/qmps/terminal_view.h"
...
QT_INIT_METAOBJECT const QMetaObject TerminalView::staticMetaObject = { {
    &QPlainTextEdit::staticMetaObject,
    qt_meta_stringdata_TerminalView.data,
    qt_meta_data_TerminalView,
    qt_static_metacall,
    nullptr,
    nullptr
} };
